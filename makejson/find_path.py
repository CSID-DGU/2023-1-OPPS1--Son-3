...
graph1 = {
    ...
    '명진관': {'D': 22, 'G': 17},
    '문화관': {'U': 105, '사회과학관': 53, '경영관': 10, '학술관': 20, 'OO': 50},
    '법학관': {'만해관': 38, 'P': 4, 'LL': 6},
    '본관1층': {'본관3층': 77, 'Q': 23, 'R': 13},
    '본관3층': {'본관1층': 77, 'J': 20, 'L': 10},
    '사회과학관': {'문화관': 53, '경영관': 57, 'QQ': 50, 'PP': 29},
    '상록원': {'A': 14, '대운동장': 37},
    '신공학관': {'Q': 32},
    '원흥관1층': {'II': 18},
    '원흥관4층': {'R': 17},
    ...
    'I': {'H': 14, 'J': 14, 'Q': 50},
    'J': {'K': 34, '팔정도': 50, 'G': 36, 'I': 14},
    'K': {'팔정도': 36, 'J': 34, 'L': 36},
    'L': {'K': 36, '팔정도': 50, 'N': 34, '다향관': 10, 'T': 30},
    'M': {'만해관': 15, 'Z': 40, 'MM': 4, '혜화관4층': 35},
    'N': {'팔정도': 36, 'O': 36, 'L': 34},
    'O': {'다향관': 7, 'N': 36, '팔정도': 52, 'P': 38, 'LL': 36},
    'P': {'법학관': 4, 'O': 38, 'F': 35, '팔정도': 41},
    'Q': {'신공학관': 32, '중앙도서관': 50, '본관1층': 23, '원흥관6층': 23, 'R': 73, 'I': 50},
    'R': {'Q': 73, '본관1층': 13, 'S': 24, 'JJ': 21, '원흥관4층': 17},
    'S': {'L': 37, 'R': 24, 'JJ': 30},
    'T': {'L': 30, 'V': 32},
    'U': {'학술관': 52, '문화관': 105, '혜화문': 43},
    'V': {'체육관': 97, 'T': 32, 'W': 31},
    ...
    'KK': {'대운동장': 20, 'X': 40, 'SS': 43},
    'LL': {'법학관': 6, 'O': 36, 'MM': 47},
    'MM': {'M': 4, 'NN': 33, 'LL': 47},
    'NN': {'MM': 33, 'OO': 52},
    'OO': {'PP': 53, '문화관': 50, '혜화문': 75, 'NN': 52},
    'PP': {'QQ': 70, '사회과학관': 29, 'OO': 53, '혜화관1층': 20},
    'QQ': {'사회과학관': 50, 'PP': 70, 'RR': 70},
    'RR': {'SS': 27, 'QQ': 70},
    'SS': {'KK': 43, 'RR': 27}
}
