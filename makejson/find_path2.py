...
graph2 = {
    ...
    '본관1층' : {'본관3층': 27.2455, 'Q': 1.2398, 'R': 0.7008},
    ...
    'M' : {'만해관': 0.8086, 'Z': 2.1562, 'MM': 2.5875, '혜화관4층': 1.8867},
    ...
    'Q' : {'신공학관': 1.725, '중앙도서관': 2.6953, '본관1층': 1.2398, '원흥관6층': 1.2398, 'R': 3.9352, 'I': 2.6953},
    'R' : {'Q': 3.9352, '본관1층': 0.7008, 'S': 1.2937, 'JJ': 1.132, '원흥관4층': 0.9164},
    'S' : {'L': 5.5045, 'R': 1.2937, 'JJ': 1.6172},
    'T' : {'L': 1.6172, 'V': 1.725},
    'U' : {'학술관': 3.8813, '문화관': 5.6602, '혜화문': 2.318},
    'V' : {'체육관': 5.2289, 'T': 3.6148, 'W': 1.6711},
    'W' : {'만해광장': 0.0539, 'JJ': 0.9703, 'V': 3.1343},
    'X' : {'F': 6.1554, 'Z': 1.8328, 'KK': 2.1562},
    ...
    'FF' : {'정보문화관': 0.4313, 'GG': 2.3255, 'AA': 1.6172},
    'GG' : {'만해광장': 10.4652, 'HH': 1.1122, 'FF': 1.2398},
    'HH' : {'GG': 0.593, 'JJ': 6.5719, 'II': 1.6172},
    'II' : {'HH': 1.6172, '원흥관1층': 0.9703, '정보문화관': 0.593},
    'JJ' : {'R': 2.3722, 'S': 1.6172, 'W': 2.2473, 'HH': 3.5039},
    'KK' : {'대운동장': 1.0781, 'X': 5.4714, 'SS': 2.318, '상록원': 15.274},
    'LL' : {'법학관': 0.3234, 'O': 6.2254, 'MM': 2.5336},
    'MM' : {'M': 4.8531, 'NN': 1.7789, 'LL': 3.6415},
    'NN' : {'MM': 8.5891, 'OO': 2.8031},
    'OO' : {'PP': 2.857, '문화관': 3.8813, '혜화문': 4.043, 'NN': 2.8031},
    'PP' : {'QQ': 3.7734, '사회과학관': 1.5633, 'OO': 2.857, '혜화관1층': 1.0781},
    'QQ' : {'사회과학관': 2.6953, 'PP': 3.7734, 'RR': 3.7734, '경영관': 4.3125},
    'RR' : {'SS': 4.342, 'QQ': 3.7734},
    'SS' : {'KK': 7.4359, 'RR': 1.4555}
}
