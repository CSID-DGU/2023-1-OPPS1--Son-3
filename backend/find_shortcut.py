...
image_info = {"만해관1" : {"title":"만해관 문", "img" : "/건물경로 이미지/만해관_문.jpg", "info" : "팔정도 출발기준 : 법학관에서 정각원 방향으로 가는 중간위치에 만해관 쪽문 있음"},
    ...
    "원흥관31" : {"title" : "원흥관 6층 통로", "img" : "/건물경로 이미지/원흥관_6층_통로.jpg", "info" : "원흥관 6층에서 내려  좌회전 -> 직진하면 왼쪽방향에 쪽문 있음"},
    "원흥관41" : {"title" : "원흥관 <-> 신공학관", "img" : "/건물경로 이미지/원흥관_연결통로.jpg", "info" : "원흥관 -> 신공학관으로 이어지는 외부통로 있음"},
    "원흥관12" : {"title" : "원흥관 엘리베이터와 연결된 계단", "img" : "/건물경로 이미지/원흥관_엘베_계단.jpg", "info" : "1층 이용 시 계단 이용"},
    "원흥관22" : {"title" : "원흥관 엘리베이터", "img" : "/건물경로 이미지/원흥관_엘베.jpg", "info" : "엘레베이터는 2층까지만 존재"},
    "원흥관32" : {"title" : "원흥관 6층 통로", "img" : "/건물경로 이미지/원흥관_6층_통로.jpg", "info" : "외부 통로 안으로 들어와서 직진 후 왼쪽 꺾어서 오른쪽 보면 엘리베이터 있음"},
