image_info = {"만해관1" : {"title":"만해관 문", "img" : "/건물경로 이미지/만해관_문.jpg", "info" : "팔정도 출발기준 : 법학관에서 정각원 방향으로 가는 중간위치에 만해관 쪽문 있음"},
    ...
    "원흥관11" : {"title" : "원흥관 엘리베이터와 연결된 계단", "img" : "/건물경로 이미지/원흥관_엘베_계단.jpg", "info" : "원흥관 내부에서 건물안으로 쭉 걸어오면 계단있음"},
    "원흥관21" : {"title" : "원흥관 엘리베이터", "img" : "/건물경로 이미지/원흥관_엘베.jpg", "info" : "원흥관 엘레베이터는 2층부터 있음"},
    "원흥관31" : {"title" : "원흥관 6층 통로", "img" : "/건물경로 이미지/원흥관 _6층 _통로.jpg", "info" : "원흥관 6층에서 내려  좌회전 -> 직진하면 왼쪽방향에 쪽문 있음"},
    "원흥관41" : {"title" : "원흥관 <-> 신공학관", "img" : "/건물경로 이미지/원흥관_연결통로.jpg", "info" : "원흥관 -> 신공학관으로 이어지는 외부통로 있음"},
    "원흥관12" : {"title" : "원흥관 엘리베이터와 연결된 계단", "img" : "/건물경로 이미지/원흥관_엘베_계단.jpg", "info" : "1층 이용 시 계단 이용"},
    "원흥관22" : {"title" : "원흥관 엘리베이터", "img" : "/건물경로 이미지/원흥관_엘베.jpg", "info" : "엘레베이터는 2층까지만 존재"},
    "원흥관32" : {"title" : "원흥관 6층 통로", "img" : "/건물경로 이미지/원흥관 _6층 _통로.jpg", "info" : "외부 통로 안으로 들어와서 직진 후 왼쪽 꺾어서 오른쪽 보면 엘리베이터 있음"},
    "원흥관42" : {"title" : "원흥관 <-> 신공학관", "img" : "/건물경로 이미지/원흥관_연결통로.jpg", "info" : "신공학관에서 원흥관을 잇는 외부 통로 있음"},
    "중앙도서관" : {"title" : "중앙도서관 뒷문", "img" : "/건물경로 이미지/중앙도서관_뒷문.jpg", "info" : "중앙도서관 정문 외에도 신공학관으로 가는길 사이에 쪽문 있음"},
    ...
    "사회과학관1" : {"title" : "사회과학관 엘리베이터", "img" : "/건물경로 이미지/사회과학관_엘베.jpg", "info" : "쿱스켓(매점)방향으로 나오면 사과관 및 경영관으로 가는 엘베 있음"},
    "사회과학관2" : {"title" : "사회과학관 엘리베이터", "img" : "/건물경로 이미지/사회과학관_엘베.jpg", "info" : "엘베 지하 1층 내려서 직진 후 오른쪽 방향 건물이 문화관"},
