...
graph = {
    ...
    'Q': {'R':56, 'J':50, '중앙도서관':5, 'KK':32, '원흥관':13},
...
for start in node_list:
    ...
    for end in node_list:
      path_start[end] = dijkstra(graph, start, end)
    path_all[start] = path_start

file_path = "./frontend/src/path.json"
with open(file_path, 'w', encoding='utf-8') as outfile:
    json.dump(path_all, outfile, ensure_ascii=False, indent=4)
